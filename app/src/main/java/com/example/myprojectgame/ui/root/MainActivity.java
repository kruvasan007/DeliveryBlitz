...
public class MainActivity extends BaseActivity {
    ...
    protected void onResume() {
        ...
        if (sh.getBoolean("firstrun", true)) {
            ...
            dao.insertOrder(new OrderData("MCDONALDS","55.02926001110971, 82.93647034818923",""+R.drawable.mcdonalds,25,10));
            dao.insertOrder(new OrderData("MCDONALDS","55.03963005768076, 82.96122777648965",""+R.drawable.mcdonalds,10,5));
            dao.insertOrder(new OrderData("MCDONALDS","55.04477301431026, 82.92285248440155",""+R.drawable.mcdonalds,40,30));
            dao.insertOrder(new OrderData("MCDONALDS","55.0106521380292, 82.93736307619466",""+R.drawable.mcdonalds,99,110));
            dao.insertOrder(new OrderData("KFC","54.989384589520384, 82.9079604150277",""+R.drawable.drumsticks,50,45));
            dao.insertOrder(new OrderData("KFC","54.985050928898104, 82.89371252068324",""+R.drawable.drumsticks,36,30));
            dao.insertOrder(new OrderData("KFC","55.04162177716465, 82.91282626462706",""+R.drawable.drumsticks,40,5));
